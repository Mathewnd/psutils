...
static const char *match_text(const struct pkill_options *opts, const psutils_process_t *process) {
	if (!opts->full_match)
		return process->name;
...
static bool attributes_match(const struct pkill_options *opts, const psutils_process_t *process) {
...
static bool pattern_match(const struct pkill_options *opts, const regex_t *regex, const psutils_process_t *process) {
...
static bool process_matches(const struct pkill_options *opts, const regex_t *regex, const psutils_process_t *process) {
...
bool pkill_process_filter(const psutils_process_t *process, void *context_ptr) {
	const struct pkill_process_filter_context *context = context_ptr;
